...
define('mobro-applet/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/hardware/hardware-card.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/hardware/hardware-card.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('components/hardware/value.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/hardware/value.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });
  ...
  QUnit.test('helpers/count.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'helpers/count.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('helpers/formatNumber.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'helpers/formatNumber.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('helpers/round.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'helpers/round.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('helpers/value.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'helpers/value.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });
  ...
  QUnit.test('routes/app/index.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/app/index.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('routes/splash.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/splash.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('services/connection.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/connection.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('services/hardware.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/hardware.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });

  QUnit.test('src/component/hardware-card.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'src/component/hardware-card.js should pass ESLint\n\n1:1 - Parsing error: The keyword \'import\' is reserved (null)');
  });
});
define('mobro-applet/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('mobro-applet/templates/app.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/app.hbs should pass TemplateLint.\n\nmobro-applet/templates/app.hbs\n  2:4  error  Incorrect indentation for `<main>` beginning at L2:C4. Expected `<main>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `<div>` beginning at L3:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  9:8  error  Incorrect indentation for `<div>` beginning at L9:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  4:12  error  Incorrect indentation for `<div>` beginning at L4:C12. Expected `<div>` to be at an indentation of 10 but was found at 12.  block-indentation\n  5:16  error  Incorrect indentation for `{{outlet}}` beginning at L5:C16. Expected `{{outlet}}` to be at an indentation of 14 but was found at 16.  block-indentation\n  10:12  error  Incorrect indentation for `<div>` beginning at L10:C12. Expected `<div>` to be at an indentation of 10 but was found at 12.  block-indentation\n  14:12  error  Incorrect indentation for `<div>` beginning at L14:C12. Expected `<div>` to be at an indentation of 10 but was found at 12.  block-indentation\n  11:16  error  Incorrect indentation for `<img>` beginning at L11:C16. Expected `<img>` to be at an indentation of 14 but was found at 16.  block-indentation\n  15:16  error  Incorrect indentation for `<div>` beginning at L15:C16. Expected `<div>` to be at an indentation of 14 but was found at 16.  block-indentation\n  16:20  error  Incorrect indentation for `{{if}}` beginning at L16:C20. Expected `{{if}}` to be at an indentation of 18 but was found at 20.  block-indentation\n  11:16  error  img tags must have an alt attribute  img-alt-attributes\n');
  });

  QUnit.test('mobro-applet/templates/app/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/app/index.hbs should pass TemplateLint.\n\nmobro-applet/templates/app/index.hbs\n  5:20  error  Incorrect indentation of positional param \'hardware/value\' beginning at L5:C20. Expected \'hardware/value\' to be at L6:C10.  attribute-indentation\n  5:37  error  Incorrect indentation of attribute \'title\' beginning at L5:C37. Expected \'title\' to be at L7:C10.  attribute-indentation\n  5:57  error  Incorrect indentation of attribute \'channel\' beginning at L5:C57. Expected \'channel\' to be at L8:C10.  attribute-indentation\n  5:96  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{component}}\' beginning at L5:C96. Expected \'{{component}}\' to be at L9:C8.  attribute-indentation\n  16:20  error  Incorrect indentation of positional param \'hardware/value\' beginning at L16:C20. Expected \'hardware/value\' to be at L17:C10.  attribute-indentation\n  16:37  error  Incorrect indentation of attribute \'title\' beginning at L16:C37. Expected \'title\' to be at L18:C10.  attribute-indentation\n  16:57  error  Incorrect indentation of attribute \'channel\' beginning at L16:C57. Expected \'channel\' to be at L19:C10.  attribute-indentation\n  16:95  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{component}}\' beginning at L16:C95. Expected \'{{component}}\' to be at L20:C8.  attribute-indentation\n  28:20  error  Incorrect indentation of positional param \'hardware/value\' beginning at L28:C20. Expected \'hardware/value\' to be at L29:C10.  attribute-indentation\n  28:37  error  Incorrect indentation of attribute \'title\' beginning at L28:C37. Expected \'title\' to be at L30:C10.  attribute-indentation\n  28:55  error  Incorrect indentation of attribute \'channel\' beginning at L28:C55. Expected \'channel\' to be at L31:C10.  attribute-indentation\n  28:89  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{component}}\' beginning at L28:C89. Expected \'{{component}}\' to be at L32:C8.  attribute-indentation\n  5:8  error  Incorrect indentation for `{{component}}` beginning at L5:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  6:8  error  Incorrect indentation for `{{component}}` beginning at L6:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  16:8  error  Incorrect indentation for `{{component}}` beginning at L16:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  17:8  error  Incorrect indentation for `{{component}}` beginning at L17:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  27:8  error  Incorrect indentation for `{{component}}` beginning at L27:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  28:8  error  Incorrect indentation for `{{component}}` beginning at L28:C8. Expected `{{component}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  4:4  error  Tables must have a table group (thead, tbody or tfoot).  table-groups\n  15:4  error  Tables must have a table group (thead, tbody or tfoot).  table-groups\n  26:4  error  Tables must have a table group (thead, tbody or tfoot).  table-groups\n');
  });

  QUnit.test('mobro-applet/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mobro-applet/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('mobro-applet/templates/components/hardware/hardware-card.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/components/hardware/hardware-card.hbs should pass TemplateLint.\n\nmobro-applet/templates/components/hardware/hardware-card.hbs\n  2:4  error  Incorrect indentation for `<div>` beginning at L2:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  7:4  error  Incorrect indentation for `<div>` beginning at L7:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `<div>` beginning at L3:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  4:21  error  Incorrect indentation for `div` beginning at L3:C8. Expected `</div>` ending at L4:C21 to be at an indentation of 8 but was found at 15.  block-indentation\n  3:26  error  Incorrect indentation for `{{title}}` beginning at L3:C26. Expected `{{title}}` to be at an indentation of 10 but was found at 26.  block-indentation\n  8:8  error  Incorrect indentation for `{{yield}}` beginning at L8:C8. Expected `{{yield}}` to be at an indentation of 6 but was found at 8.  block-indentation\n');
  });

  QUnit.test('mobro-applet/templates/components/hardware/value.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mobro-applet/templates/components/hardware/value.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('mobro-applet/templates/fallout-app.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/fallout-app.hbs should pass TemplateLint.\n\nmobro-applet/templates/fallout-app.hbs\n  2:4  error  Incorrect indentation for `<header>` beginning at L2:C4. Expected `<header>` to be at an indentation of 2 but was found at 4.  block-indentation\n  22:4  error  Incorrect indentation for `<main>` beginning at L22:C4. Expected `<main>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `<div>` beginning at L3:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  5:8  error  Incorrect indentation for `<div>` beginning at L5:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  9:8  error  Incorrect indentation for `<div>` beginning at L9:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  13:8  error  Incorrect indentation for `<div>` beginning at L13:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  17:8  error  Incorrect indentation for `<div>` beginning at L17:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  5:26  error  Incorrect indentation for `\n            PIP-TEC 3000\n        ` beginning at L5:C26. Expected `\n            PIP-TEC 3000\n        ` to be at an indentation of 10 but was found at 12.  block-indentation\n  9:60  error  Incorrect indentation for `\n            RobCo Industries\n        ` beginning at L9:C60. Expected `\n            RobCo Industries\n        ` to be at an indentation of 10 but was found at 12.  block-indentation\n  13:65  error  Incorrect indentation for `\n            Status: ` beginning at L13:C65. Expected `\n            Status: ` to be at an indentation of 10 but was found at 12.  block-indentation\n  17:65  error  Incorrect indentation for `\n            ModBros: initialized\n        ` beginning at L17:C65. Expected `\n            ModBros: initialized\n        ` to be at an indentation of 10 but was found at 12.  block-indentation\n  23:8  error  Incorrect indentation for `{{outlet}}` beginning at L23:C8. Expected `{{outlet}}` to be at an indentation of 6 but was found at 8.  block-indentation\n');
  });

  QUnit.test('mobro-applet/templates/fallout-splash.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/fallout-splash.hbs should pass TemplateLint.\n\nmobro-applet/templates/fallout-splash.hbs\n  2:4  error  Incorrect indentation for `<div>` beginning at L2:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `{{#each}}` beginning at L3:C8. Expected `{{#each}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  5:12  error  Incorrect indentation for `<div>` beginning at L5:C12. Expected `<div>` to be at an indentation of 10 but was found at 12.  block-indentation\n  6:16  error  Incorrect indentation for `{{message}}` beginning at L6:C16. Expected `{{message}}` to be at an indentation of 14 but was found at 16.  block-indentation\n');
  });

  QUnit.test('mobro-applet/templates/splash.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mobro-applet/templates/splash.hbs should pass TemplateLint.\n\nmobro-applet/templates/splash.hbs\n  2:4  error  Incorrect indentation for `<img>` beginning at L2:C4. Expected `<img>` to be at an indentation of 2 but was found at 4.  block-indentation\n  2:4  error  img tags must have an alt attribute  img-alt-attributes\n  2:4  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });
});
define('mobro-applet/tests/lint/tests.lint-test', [], function () {
  'use strict';
...
define('mobro-applet/tests/test-helper', ['mobro-applet/app', 'mobro-applet/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('mobro-applet/tests/test-helper');
